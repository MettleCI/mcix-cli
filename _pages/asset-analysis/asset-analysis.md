...
Static code analysis is the analysis of a computer program's code without executing that code; In DataStage NextGen this is referred to as **Asset Analysis** and in available on the MettleCI command line by the [mcix flow-analysis](../command-ref/asset-analysis-namespace) namespace.  This approach contrasts with dynamic program analysis, which is performed on programs during their execution and is achieved in DataStage by creating and running a DataStage [Unit Test Case](../testing/testing-datastage-flows.md).  
